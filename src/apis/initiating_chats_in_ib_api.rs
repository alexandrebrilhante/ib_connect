...
pub async fn post_initiate_chat(configuration: &configuration::Configuration, chat_initiation_request: models::ChatInitiationRequest) -> Result<models::PostInitiateChat202Response, Error<PostInitiateChatError>> {
