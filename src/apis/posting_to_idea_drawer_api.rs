...
pub async fn post_response_to_stream(configuration: &configuration::Configuration, stream_id: &str, post_response: models::PostResponse) -> Result<models::PostResponseToStream200Response, Error<PostResponseToStreamError>> {
