...
pub struct StructuredTemplateFieldsOtherInstrument {
...
impl StructuredTemplateFieldsOtherInstrument {
    pub fn new() -> StructuredTemplateFieldsOtherInstrument {
        StructuredTemplateFieldsOtherInstrument {
            figi: None,
