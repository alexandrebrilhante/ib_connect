...
pub struct EnrichmentFieldsCommonFieldsPremiumOneOf {
...
impl EnrichmentFieldsCommonFieldsPremiumOneOf {
    pub fn new() -> EnrichmentFieldsCommonFieldsPremiumOneOf {
        EnrichmentFieldsCommonFieldsPremiumOneOf {
            premium_type: None,
            currency: None,
            at_type: None,
            bid: None,
