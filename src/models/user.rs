...
pub struct User {
    ...
    #[serde(rename = "gpi", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub gpi: Option<Option<String>>,
    #[serde(rename = "firmId", skip_serializing_if = "Option::is_none")]
    pub firm_id: Option<i64>,
    #[serde(rename = "firmName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
