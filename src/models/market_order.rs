...
impl MarketOrder {
    pub fn new(side: models::Side, size: models::Size, instrument: models::Instrument, order_type: OrderType, order_status: models::Status, timestamp: models::Timestamp, client: models::Client, broker: models::Broker, filled_quantity: models::FilledQuantity, average_price: models::AveragePrice) -> MarketOrder {
        MarketOrder {
            side,
            size,
            instrument,
