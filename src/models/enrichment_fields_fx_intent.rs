...
/// EnrichmentFieldsFxIntent : Generic group Intent
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EnrichmentFieldsFxIntent {
    /// Confidence level
...
impl EnrichmentFieldsFxIntent {
    /// Generic group Intent
    pub fn new() -> EnrichmentFieldsFxIntent {
        EnrichmentFieldsFxIntent {
