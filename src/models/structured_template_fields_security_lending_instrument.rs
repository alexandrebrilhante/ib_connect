...
pub struct StructuredTemplateFieldsSecurityLendingInstrument {
...
impl StructuredTemplateFieldsSecurityLendingInstrument {
    pub fn new() -> StructuredTemplateFieldsSecurityLendingInstrument {
        StructuredTemplateFieldsSecurityLendingInstrument {
            bbid: None,
            cusip: None,
            exchange: None,
            figi: None,
