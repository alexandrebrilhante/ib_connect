...
pub struct StructuredTemplateFieldsOptionInstrumentLegsInner {
...
impl StructuredTemplateFieldsOptionInstrumentLegsInner {
    pub fn new() -> StructuredTemplateFieldsOptionInstrumentLegsInner {
        StructuredTemplateFieldsOptionInstrumentLegsInner {
            r#type: None,
