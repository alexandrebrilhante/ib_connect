...
pub struct EnrichmentFieldsSecurityLendingInstrument {
...
impl EnrichmentFieldsSecurityLendingInstrument {
    pub fn new() -> EnrichmentFieldsSecurityLendingInstrument {
        EnrichmentFieldsSecurityLendingInstrument {
            bbid: None,
