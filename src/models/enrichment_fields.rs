...
pub struct EnrichmentFields {
    ...
    /// Quantity
    #[serde(rename = "common_fields_amount", skip_serializing_if = "Option::is_none")]
    pub common_fields_amount: Option<f64>,
    /// Currency of amount being traded
    #[serde(rename = "common_fields_amount_currency", skip_serializing_if = "Option::is_none")]
    pub common_fields_amount_currency: Option<String>,
    /// The price of a security
    #[serde(rename = "common_fields_ask_price", skip_serializing_if = "Option::is_none")]
    pub common_fields_ask_price: Option<f64>,
    /// Ask size (in security currency)
    #[serde(rename = "common_fields_ask_size", skip_serializing_if = "Option::is_none")]
    pub common_fields_ask_size: Option<f64>,
    /// Ask value of a price_type for the quote
    #[serde(rename = "common_fields_ask_value", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "common_fields_benchmark", skip_serializing_if = "Option::is_none")]
    pub common_fields_benchmark: Option<String>,
    /// Yellowkey of benchmark security
    #[serde(rename = "common_fields_benchmark_yellow_key", skip_serializing_if = "Option::is_none")]
    pub common_fields_benchmark_yellow_key: Option<CommonFieldsBenchmarkYellowKey>,
    /// Bid price
    #[serde(rename = "common_fields_bid_price", skip_serializing_if = "Option::is_none")]
    pub common_fields_bid_price: Option<f64>,
    /// Bid size (in security currency)
    #[serde(rename = "common_fields_bid_size", skip_serializing_if = "Option::is_none")]
    pub common_fields_bid_size: Option<f64>,
    /// Bid value of a price_type for the quote
    #[serde(rename = "common_fields_bid_value", skip_serializing_if = "Option::is_none")]
    pub common_fields_bid_value: Option<f64>,
    /// Brand name for credit default swap index
    #[serde(rename = "common_fields_cdx_group", skip_serializing_if = "Option::is_none")]
    pub common_fields_cdx_group: Option<String>,
    /// Bloomberg Company Identifier
    #[serde(rename = "common_fields_collateral", skip_serializing_if = "Option::is_none")]
    pub common_fields_collateral: Option<String>,
    /// Confidence level
    #[serde(rename = "common_fields_confidence_type", skip_serializing_if = "Option::is_none")]
    pub common_fields_confidence_type: Option<CommonFieldsConfidenceType>,
    /// Coupon
    #[serde(rename = "common_fields_coupon", skip_serializing_if = "Option::is_none")]
    pub common_fields_coupon: Option<f64>,
    /// Three letter Currency identifier
    #[serde(rename = "common_fields_currency", skip_serializing_if = "Option::is_none")]
    pub common_fields_currency: Option<String>,
    /// Currency pair
    #[serde(rename = "common_fields_currency_pair", skip_serializing_if = "Option::is_none")]
    pub common_fields_currency_pair: Option<String>,
    /// Current outstanding value
    #[serde(rename = "common_fields_current_face", skip_serializing_if = "Option::is_none")]
    ...
    /// Option delta
    #[serde(rename = "common_fields_delta", skip_serializing_if = "Option::is_none")]
    pub common_fields_delta: Option<f64>,
    #[serde(rename = "common_fields_delta_hedge_notional", skip_serializing_if = "Option::is_none")]
    pub common_fields_delta_hedge_notional: Option<Box<models::EnrichmentFieldsCommonFieldsDeltaHedgeNotional>>,
    /// Type of FX derivative option
    #[serde(rename = "common_fields_derivative_type", skip_serializing_if = "Option::is_none")]
    pub common_fields_derivative_type: Option<CommonFieldsDerivativeType>,
    /// Direction of quote
    #[serde(rename = "common_fields_direction", skip_serializing_if = "Option::is_none")]
    pub common_fields_direction: Option<CommonFieldsDirection>,
    /// Equity price associated with bond
    #[serde(rename = "common_fields_equity_price", skip_serializing_if = "Option::is_none")]
    pub common_fields_equity_price: Option<f64>,
    /// Exchange code
    #[serde(rename = "common_fields_exchange", skip_serializing_if = "Option::is_none")]
    pub common_fields_exchange: Option<String>,
    /// Option expiry cut-off
    #[serde(rename = "common_fields_expiration_cut", skip_serializing_if = "Option::is_none")]
    pub common_fields_expiration_cut: Option<String>,
    #[serde(rename = "common_fields_expiration_date", skip_serializing_if = "Option::is_none")]
    pub common_fields_expiration_date: Option<Box<models::StructuredTemplateFieldsCommonFieldsExpirationDate>>,
    ...
    #[serde(rename = "common_fields_firmness", skip_serializing_if = "Option::is_none")]
    pub common_fields_firmness: Option<CommonFieldsFirmness>,
    /// Natural Indication of Interest (see FINRA regulatory notice 11-43).
    #[serde(rename = "common_fields_if_natural", skip_serializing_if = "Option::is_none")]
    pub common_fields_if_natural: Option<bool>,
    /// True if the repo does not have a fixed maturity date
    #[serde(rename = "common_fields_is_open", skip_serializing_if = "Option::is_none")]
    pub common_fields_is_open: Option<bool>,
    /// True if the repo trade is carried over from a prior trade
    #[serde(rename = "common_fields_is_roll", skip_serializing_if = "Option::is_none")]
    pub common_fields_is_roll: Option<bool>,
    /// Free-form string to identify leg information in various sections
    #[serde(rename = "common_fields_leg_id", skip_serializing_if = "Option::is_none")]
    pub common_fields_leg_id: Option<String>,
    /// Ratio of an option leg
    #[serde(rename = "common_fields_leg_ratio", skip_serializing_if = "Option::is_none")]
    pub common_fields_leg_ratio: Option<f64>,
    /// Company id of loan
    #[serde(rename = "common_fields_loan_company_id", skip_serializing_if = "Option::is_none")]
    pub common_fields_loan_company_id: Option<String>,
    #[serde(rename = "common_fields_maturity_date", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "common_fields_normalized_delta", skip_serializing_if = "Option::is_none")]
    pub common_fields_normalized_delta: Option<f64>,
    #[serde(rename = "common_fields_notional", skip_serializing_if = "Option::is_none")]
    pub common_fields_notional: Option<Box<models::EnrichmentFieldsCommonFieldsNotional>>,
    /// The size of a deal in notional ammount
    #[serde(rename = "common_fields_notional_size", skip_serializing_if = "Option::is_none")]
    pub common_fields_notional_size: Option<f64>,
    /// An option style
    #[serde(rename = "common_fields_option_style", skip_serializing_if = "Option::is_none")]
    pub common_fields_option_style: Option<CommonFieldsOptionStyle>,
    /// The quote execution strategy
    #[serde(rename = "common_fields_order_type", skip_serializing_if = "Option::is_none")]
    pub common_fields_order_type: Option<CommonFieldsOrderType>,
    /// Premium for security over the base price
    #[serde(rename = "common_fields_payup", skip_serializing_if = "Option::is_none")]
    pub common_fields_payup: Option<f64>,
    /// Quoted points for the leg
    #[serde(rename = "common_fields_points", skip_serializing_if = "Option::is_none")]
    pub common_fields_points: Option<f64>,
    /// Currently supported intent names
    #[serde(rename = "common_fields_post_intent_name", skip_serializing_if = "Option::is_none")]
    pub common_fields_post_intent_name: Option<CommonFieldsPostIntentName>,
    #[serde(rename = "common_fields_premium", skip_serializing_if = "Option::is_none")]
    pub common_fields_premium: Option<Box<models::EnrichmentFieldsCommonFieldsPremium>>,
    #[serde(rename = "common_fields_premium_type", skip_serializing_if = "Option::is_none")]
    pub common_fields_premium_type: Option<CommonFieldsPremiumType>,
    /// Rate at which loan can be prepaid
    #[serde(rename = "common_fields_prepay", skip_serializing_if = "Option::is_none")]
    pub common_fields_prepay: Option<String>,
    /// The price of a security
    #[serde(rename = "common_fields_price", skip_serializing_if = "Option::is_none")]
    pub common_fields_price: Option<f64>,
    /// Put call code of the option
    #[serde(rename = "common_fields_put_call_code", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "common_fields_strike_price", skip_serializing_if = "Option::is_none")]
    pub common_fields_strike_price: Option<String>,
    /// Tenor associated with security.
    #[serde(rename = "common_fields_tenor", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "common_fields_ticker", skip_serializing_if = "Option::is_none")]
    pub common_fields_ticker: Option<String>,
    #[serde(rename = "common_fields_underlying", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "common_fields_volatility", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "common_fields_year_definition", skip_serializing_if = "Option::is_none")]
    pub common_fields_year_definition: Option<f64>,
    /// Yellow key of security
    #[serde(rename = "common_fields_yellow_key", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "credit_derivative_quote_quote", skip_serializing_if = "Option::is_none")]
    pub credit_derivative_quote_quote: Option<Box<models::EnrichmentFieldsCreditDerivativeQuoteQuote>>,
    #[serde(rename = "credit_derivative_quote_value_type", skip_serializing_if = "Option::is_none")]
    pub credit_derivative_quote_value_type: Option<CreditDerivativeQuoteValueType>,
    #[serde(rename = "credit_derivative_quote_values", skip_serializing_if = "Option::is_none")]
    pub credit_derivative_quote_values: Option<Vec<models::EnrichmentFieldsCreditDerivativeQuoteValuesInner>>,
    #[serde(rename = "entity_person_instrument_instrument", skip_serializing_if = "Option::is_none")]
    pub entity_person_instrument_instrument: Option<Box<models::EnrichmentFieldsEntityPersonInstrumentInstrument>>,
    ...
    #[serde(rename = "fixed_income_cash_quote_value_type", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "fixed_income_cash_quote_values", skip_serializing_if = "Option::is_none")]
    pub fixed_income_cash_quote_values: Option<Vec<models::EnrichmentFieldsFixedIncomeCashQuoteValuesInner>>,
    #[serde(rename = "fx_cash_instrument_instrument", skip_serializing_if = "Option::is_none")]
    pub fx_cash_instrument_instrument: Option<Box<models::EnrichmentFieldsFxCashInstrumentInstrument>>,
    #[serde(rename = "fx_cash_instrument_leg", skip_serializing_if = "Option::is_none")]
    pub fx_cash_instrument_leg: Option<Box<models::EnrichmentFieldsFxCashInstrumentLeg>>,
    #[serde(rename = "fx_cash_quote_quote", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "fx_derivative_instrument_instrument", skip_serializing_if = "Option::is_none")]
    pub fx_derivative_instrument_instrument: Option<Box<models::EnrichmentFieldsFxDerivativeInstrumentInstrument>>,
    #[serde(rename = "fx_derivative_instrument_leg", skip_serializing_if = "Option::is_none")]
    pub fx_derivative_instrument_leg: Option<Box<models::EnrichmentFieldsFxDerivativeInstrumentLeg>>,
    #[serde(rename = "fx_derivative_instrument_legs", skip_serializing_if = "Option::is_none")]
    pub fx_derivative_instrument_legs: Option<Vec<models::FxDerivativeInstrumentLeg>>,
    #[serde(rename = "intent_intent_post_intent", skip_serializing_if = "Option::is_none")]
    pub intent_intent_post_intent: Option<Box<models::EnrichmentFieldsIntentIntentPostIntent>>,
    #[serde(rename = "mortgage_quote_value_type", skip_serializing_if = "Option::is_none")]
    pub mortgage_quote_value_type: Option<MortgageQuoteValueType>,
    #[serde(rename = "mortgage_quote_values", skip_serializing_if = "Option::is_none")]
    pub mortgage_quote_values: Option<Vec<models::EnrichmentFieldsMortgageQuoteValuesInner>>,
    #[serde(rename = "option_instrument_instrument_underlying", skip_serializing_if = "Option::is_none")]
    pub option_instrument_instrument_underlying: Option<Box<models::EnrichmentFieldsOptionInstrumentInstrumentUnderlying>>,
    /// A leg side of the option
    #[serde(rename = "option_instrument_leg_side", skip_serializing_if = "Option::is_none")]
    pub option_instrument_leg_side: Option<OptionInstrumentLegSide>,
    /// A leg type of the option
    #[serde(rename = "option_instrument_leg_type", skip_serializing_if = "Option::is_none")]
    pub option_instrument_leg_type: Option<OptionInstrumentLegType>,
    /// Strike price of the option
    #[serde(rename = "option_instrument_strike_price", skip_serializing_if = "Option::is_none")]
    pub option_instrument_strike_price: Option<f64>,
    #[serde(rename = "other_instrument_instrument", skip_serializing_if = "Option::is_none")]
